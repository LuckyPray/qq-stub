...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProStickyChannelGuild.class */
public final class GProStickyChannelGuild {
    ...
    public boolean getHasStickyChannel() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 3)) ? this.hasStickyChannel : ((Boolean) iPatchRedirector.redirect((short) 3, this)).booleanValue();
    }
