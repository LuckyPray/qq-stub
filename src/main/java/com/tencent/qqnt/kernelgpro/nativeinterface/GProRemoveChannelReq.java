...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProRemoveChannelReq.class */
public final class GProRemoveChannelReq {
    ...
    public int getMovePost() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 5)) ? this.movePost : ((Integer) iPatchRedirector.redirect((short) 5, this)).intValue();
    }
    ...
    public GProRemoveChannelReq(long j, long j2, int i) {
        IPatchRedirector iPatchRedirector = $redirector_;
