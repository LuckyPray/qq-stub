...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProFeedThumbnail.class */
public final class GProFeedThumbnail implements Serializable {
    ...
    public boolean getIsVideoCover() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 3)) ? this.isVideoCover : ((Boolean) iPatchRedirector.redirect((short) 3, this)).booleanValue();
    }
