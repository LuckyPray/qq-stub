...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProContentRecommendFeedsGuild.class */
public final class GProContentRecommendFeedsGuild implements Serializable {
    static IPatchRedirector $redirector_;
    public ArrayList<GProContentRecommendFeed> feeds;
    long serialVersionUID;

    public GProContentRecommendFeedsGuild() {
