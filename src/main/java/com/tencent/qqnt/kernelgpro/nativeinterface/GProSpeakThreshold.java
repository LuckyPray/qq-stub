...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProSpeakThreshold.class */
public final class GProSpeakThreshold implements Serializable {
    ...
    public String toString() {
        ...
        return "GProSpeakThreshold{needRealName=" + this.needRealName + ",needHasJoinRole=" + this.needHasJoinRole + ",needJoinTime=" + this.needJoinTime + ",}";
    }
}
