...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProChannelCategoryInfo.class */
public final class GProChannelCategoryInfo implements Serializable {
    ...
    public GProChannelCategoryInfo() {
    ...
    public int getChannelIndex() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 3)) ? this.channelIndex : ((Integer) iPatchRedirector.redirect((short) 3, this)).intValue();
    }
