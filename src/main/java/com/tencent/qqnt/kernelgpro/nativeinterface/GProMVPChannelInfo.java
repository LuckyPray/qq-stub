...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProMVPChannelInfo.class */
public final class GProMVPChannelInfo {
    static IPatchRedirector $redirector_;
    public long channelId;
    public long guildId;
    public byte[] joinGuildSign;

    public GProMVPChannelInfo() {
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 1)) {
            this.joinGuildSign = new byte[0];
        } else {
    ...
    public byte[] getJoinGuildSign() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 4)) ? this.joinGuildSign : (byte[]) iPatchRedirector.redirect((short) 4, this);
    }
