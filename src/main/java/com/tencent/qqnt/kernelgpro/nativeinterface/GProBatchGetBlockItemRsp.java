...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProBatchGetBlockItemRsp.class */
public final class GProBatchGetBlockItemRsp implements Serializable {
    static IPatchRedirector $redirector_;
    public byte[] cookies;
    public boolean isEnd;
    public ArrayList<GProBlockInfo> items;
    public String msg;
    ...
    public String toString() {
        ...
        return "GProBatchGetBlockItemRsp{traceId=" + this.traceId + ",items=" + this.items + ",msg=" + this.msg + ",isEnd=" + this.isEnd + ",cookies=" + this.cookies + ",}";
    }
