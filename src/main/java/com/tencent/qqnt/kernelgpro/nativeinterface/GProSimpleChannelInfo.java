...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProSimpleChannelInfo.class */
public final class GProSimpleChannelInfo {
    ...
    public int getHiddenPostChannel() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 4)) ? this.hiddenPostChannel : ((Integer) iPatchRedirector.redirect((short) 4, this)).intValue();
    }
