...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProScheduleFloatingLayerDetail.class */
public final class GProScheduleFloatingLayerDetail {
    static IPatchRedirector $redirector_;
    public long channelId;
    public long guildId;
    public GProScheduleInfo scheduleInfo;

    public GProScheduleFloatingLayerDetail() {
    ...
    public String toString() {
        ...
        return "GProScheduleFloatingLayerDetail{scheduleInfo=" + this.scheduleInfo + ",guildId=" + this.guildId + ",channelId=" + this.channelId + ",}";
    }
}
