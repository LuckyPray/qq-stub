...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProSubscribeUserGuide.class */
public final class GProSubscribeUserGuide {
    ...
    public String getCover() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 7)) ? this.cover : (String) iPatchRedirector.redirect((short) 7, this);
    }
    ...
    public String getProfile() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 6)) ? this.profile : (String) iPatchRedirector.redirect((short) 6, this);
    }
    ...
    public GProSubscribeUserGuide(long j, String str, String str2, String str3, String str4) {
        IPatchRedirector iPatchRedirector = $redirector_;
