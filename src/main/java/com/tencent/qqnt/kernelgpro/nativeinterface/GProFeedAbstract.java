...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProFeedAbstract.class */
public final class GProFeedAbstract {
    static IPatchRedirector $redirector_;
    public String feedId;
    public ArrayList<GProThumbnail> thumbnailList;
    public String title;

    public GProFeedAbstract() {
    ...
    public ArrayList<GProThumbnail> getThumbnailList() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 4)) ? this.thumbnailList : (ArrayList) iPatchRedirector.redirect((short) 4, this);
    }
