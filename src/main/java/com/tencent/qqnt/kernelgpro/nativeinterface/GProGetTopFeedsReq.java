...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProGetTopFeedsReq.class */
public final class GProGetTopFeedsReq {
    ...
    public int getServiceType() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 4)) ? this.serviceType : ((Integer) iPatchRedirector.redirect((short) 4, this)).intValue();
    }
