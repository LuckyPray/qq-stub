...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProAVCommonReqInfo.class */
public final class GProAVCommonReqInfo {
    ...
    public GProAVCommonReqInfo(long j, long j2, long j3) {
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 2)) {
            iPatchRedirector.redirect((short) 2, new Object[]{this, Long.valueOf(j), Long.valueOf(j2), Long.valueOf(j3)});
            return;
        }
        this.guildId = j;
        this.channelId = j2;
