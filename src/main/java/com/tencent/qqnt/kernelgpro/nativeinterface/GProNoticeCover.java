...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProNoticeCover.class */
public final class GProNoticeCover {
    ...
    public long getLinkId() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 3)) ? this.linkId : ((Long) iPatchRedirector.redirect((short) 3, this)).longValue();
    }
