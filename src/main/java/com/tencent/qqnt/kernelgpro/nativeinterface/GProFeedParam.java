...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProFeedParam.class */
public final class GProFeedParam {
    ...
    public String getUserId() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 2)) ? this.userId : (String) iPatchRedirector.redirect((short) 2, this);
    }
