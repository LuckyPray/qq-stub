...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProLobbyMemberInfo.class */
public final class GProLobbyMemberInfo implements Serializable {
    ...
    public boolean getPlaying() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 6)) ? this.playing : ((Boolean) iPatchRedirector.redirect((short) 6, this)).booleanValue();
    }
    ...
    public long getUin() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 2)) ? this.uin : ((Long) iPatchRedirector.redirect((short) 2, this)).longValue();
    }
