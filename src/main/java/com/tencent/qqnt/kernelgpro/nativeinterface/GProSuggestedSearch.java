...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProSuggestedSearch.class */
public final class GProSuggestedSearch {
    ...
    public ArrayList<String> getContentList() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 3)) ? this.contentList : (ArrayList) iPatchRedirector.redirect((short) 3, this);
    }
