...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProScheduleDate.class */
public final class GProScheduleDate {
    ...
    public int getInviteStatus() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 3)) ? this.inviteStatus : ((Integer) iPatchRedirector.redirect((short) 3, this)).intValue();
    }
