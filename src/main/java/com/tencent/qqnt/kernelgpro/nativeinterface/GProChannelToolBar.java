...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProChannelToolBar.class */
public final class GProChannelToolBar implements Serializable {
    ...
    public String getToolbarListStr() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 3)) ? this.toolbarListStr : (String) iPatchRedirector.redirect((short) 3, this);
    }
