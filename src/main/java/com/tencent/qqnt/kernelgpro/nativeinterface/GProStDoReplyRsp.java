...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProStDoReplyRsp.class */
public final class GProStDoReplyRsp {
    ...
    public GProStReply getReply() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 3)) ? this.reply : (GProStReply) iPatchRedirector.redirect((short) 3, this);
    }
