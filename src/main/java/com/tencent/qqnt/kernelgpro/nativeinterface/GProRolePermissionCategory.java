...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProRolePermissionCategory.class */
public final class GProRolePermissionCategory {
    ...
    public int getPackCount() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 4)) ? this.packCount : ((Integer) iPatchRedirector.redirect((short) 4, this)).intValue();
    }
    ...
    public GProRolePermissionCategory(String str, int i) {
        IPatchRedirector iPatchRedirector = $redirector_;
