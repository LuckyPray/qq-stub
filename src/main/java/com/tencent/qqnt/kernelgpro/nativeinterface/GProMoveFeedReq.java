...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProMoveFeedReq.class */
public final class GProMoveFeedReq {
    ...
    public long getOriginalChannelId() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 4)) ? this.originalChannelId : ((Long) iPatchRedirector.redirect((short) 4, this)).longValue();
    }
