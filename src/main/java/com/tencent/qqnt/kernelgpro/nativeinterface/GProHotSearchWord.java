...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProHotSearchWord.class */
public final class GProHotSearchWord {
    ...
    public String getLink() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 6)) ? this.link : (String) iPatchRedirector.redirect((short) 6, this);
    }
    ...
    public String getWord() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 4)) ? this.word : (String) iPatchRedirector.redirect((short) 4, this);
    }
