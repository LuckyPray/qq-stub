...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProLiveDataItem.class */
public final class GProLiveDataItem {
    ...
    public long getValue() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 4)) ? this.value : ((Long) iPatchRedirector.redirect((short) 4, this)).longValue();
    }
