...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProPAReportExecuteRsp.class */
public final class GProPAReportExecuteRsp {
    ...
    public String toString() {
        ...
        return "GProPAReportExecuteRsp{ret=" + this.ret + ",msg=" + this.msg + ",}";
    }

    public GProPAReportExecuteRsp(int i, String str) {
        IPatchRedirector iPatchRedirector = $redirector_;
