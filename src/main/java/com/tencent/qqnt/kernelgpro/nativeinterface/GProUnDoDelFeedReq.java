...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProUnDoDelFeedReq.class */
public final class GProUnDoDelFeedReq {
    ...
    public long getCreateTime() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 3)) ? this.createTime : ((Long) iPatchRedirector.redirect((short) 3, this)).longValue();
    }
