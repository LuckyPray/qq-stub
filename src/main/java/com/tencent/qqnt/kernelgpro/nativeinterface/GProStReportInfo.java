...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProStReportInfo.class */
public final class GProStReportInfo {
    static IPatchRedirector $redirector_;
    public byte[] busiReport;
    public String idd;

    public GProStReportInfo() {
    ...
    public byte[] getBusiReport() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 3)) ? this.busiReport : (byte[]) iPatchRedirector.redirect((short) 3, this);
    }
