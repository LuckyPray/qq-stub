...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProGuidePageInfo.class */
public final class GProGuidePageInfo {
    static IPatchRedirector $redirector_;
    public String desc;
    public GProImgPair images;
    public String title;
    ...
    public GProImgPair getImages() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 4)) ? this.images : (GProImgPair) iPatchRedirector.redirect((short) 4, this);
    }
