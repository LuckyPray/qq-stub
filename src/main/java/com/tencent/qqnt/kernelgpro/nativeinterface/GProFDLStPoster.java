...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProFDLStPoster.class */
public final class GProFDLStPoster {
    ...
    public String toString() {
        ...
        return "GProFDLStPoster{userId=" + this.userId + ",}";
    }

    public GProFDLStPoster(String str) {
        IPatchRedirector iPatchRedirector = $redirector_;
