...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProDoFeedPreferRsp.class */
public final class GProDoFeedPreferRsp {
    static IPatchRedirector $redirector_;
    public int preferCount;

    public GProDoFeedPreferRsp() {
    ...
    public String toString() {
        ...
        return "GProDoFeedPreferRsp{preferCount=" + this.preferCount + ",}";
    }
}
