...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProGuildChannelState.class */
public final class GProGuildChannelState {
    ...
    public int getState() {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 2)) ? this.state : ((Integer) iPatchRedirector.redirect((short) 2, this)).intValue();
    }
