...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProSetJumpToCategoryReq.class */
public final class GProSetJumpToCategoryReq {
    static IPatchRedirector $redirector_;
    public long categoryId;
    public long guildId;

    public GProSetJumpToCategoryReq() {
    ...
    public String toString() {
        ...
        return "GProSetJumpToCategoryReq{guildId=" + this.guildId + ",categoryId=" + this.categoryId + ",}";
    }
}
