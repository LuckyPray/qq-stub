...
/* loaded from: classes.jar:com/tencent/qqnt/kernelgpro/nativeinterface/GProImpeachRsp.class */
public final class GProImpeachRsp {
    static IPatchRedirector $redirector_;
    public GProStCommonExt extInfo;

    public GProImpeachRsp() {
    ...
    public String toString() {
        ...
        return "GProImpeachRsp{extInfo=" + this.extInfo + ",}";
    }
}
