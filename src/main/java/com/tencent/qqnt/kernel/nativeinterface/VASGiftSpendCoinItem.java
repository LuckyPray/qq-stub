...
public final class VASGiftSpendCoinItem implements Serializable {
    ...
    public int getAmt() {
        ...
        return redirector != null ? ((Integer) redirector.redirect((short) 4, (Object) this)).intValue() : this.amt;
    }

    public int getCoinType() {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(94987, (short) 3);
        return redirector != null ? ((Integer) redirector.redirect((short) 3, (Object) this)).intValue() : this.coinType;
    }
