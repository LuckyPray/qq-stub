...
/* compiled from: P */
/* loaded from: classes.jar:com/tencent/qqnt/kernel/nativeinterface/SearchVerticalList.class */
public final class SearchVerticalList {
    ...
    public String toString() {
        return "SearchVerticalList{title=" + this.title + ",subTitle=" + this.subTitle + ",button=" + this.button + ",listList=" + this.listList + ",}";
    }
}
