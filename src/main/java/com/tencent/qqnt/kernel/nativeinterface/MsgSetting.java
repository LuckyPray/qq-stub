...
/* compiled from: P */
/* loaded from: classes.jar:com/tencent/qqnt/kernel/nativeinterface/MsgSetting.class */
public final class MsgSetting implements IKernelModel {
    public Integer callRemind;
    public Integer careCueTone;
    public Integer cueTone;
    public Integer groupSound;
    public Integer groupVibrate;
    public Integer msgNotify;
    public Integer msgPreview;
    public Integer noDisturbTime;
    public Integer sound;
    public Integer topRemind;
