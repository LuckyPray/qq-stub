...
/* compiled from: P */
/* loaded from: classes.jar:com/tencent/qqnt/kernel/nativeinterface/SceneDetailInfo.class */
public final class SceneDetailInfo {
    public BasicPointInfo basicPoint;
    public BubblePointInfo bubblePoint;
    public NumericPointInfo numericPoint;
    public PointType pointType;
    public GuildGroupSceneType sceneType;
