...
/* loaded from: classes.jar:com/tencent/qqnt/kernelpublic/nativeinterface/XmlToJsonParam.class */
public final class XmlToJsonParam implements Serializable {
    ...
    public XmlToJsonParam(long j, long j2, int i, int i2, int i3, String str, Long l, Long l2, HashMap<String, String> hashMap, byte[] bArr, HashMap<String, String> hashMap2) {
        IPatchRedirector iPatchRedirector = $redirector_;
