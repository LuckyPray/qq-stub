...
public class BaseConstants {
    ...
    public static String[] CMD_NeedBootPushCmdHeads = new String[]{"VideoSvc", "SharpSvr.s2c", "MessageSvc.Push", "OnlinePush"};
    public static String[] CMD_NeedResendCmds = new String[]{CMD_MSG_PBSENDMSG, "MessageSvc.SendMsg", "MessageSvc.offlinemsg", "MessageSvc.SendGroupMsg"};
    ...
    public static final byte UINTYPE_QQ = (byte) 0;
    ...
    public static final String revision = "386588";
    public static String testIpv6ServerAddress = "";
