...
public final class SvcRspGetDevLoginInfo extends JceStruct implements Cloneable {
    ...
    public SvcRspGetDevLoginInfo(int i2, String str, long j2, long j3, ArrayList<SvcDevLoginInfo> arrayList, ArrayList<SvcDevLoginInfo> arrayList2, ArrayList<SvcDevLoginInfo> arrayList3) {
        throw new RuntimeException("stub");
    }
}
