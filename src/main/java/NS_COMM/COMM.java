...
public final class COMM {
    ...
    public static final class BytesEntry extends MessageMicro<BytesEntry> {
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18}, new String[]{"key", "value"}, new Object[]{"", ByteStringMicro.EMPTY}, BytesEntry.class);
    ...
    public static final class Entry extends MessageMicro<Entry> {
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18}, new String[]{"key", "value"}, new Object[]{"", ""}, Entry.class);
        public final PBStringField key = PBField.initString("");
    ...
    public static final class Result extends MessageMicro<Result> {
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18}, new String[]{"retCode", "msg"}, new Object[]{0, ""}, Result.class);
        public final PBInt32Field retCode = PBField.initInt32(0);

        /* renamed from: msg  reason: collision with root package name */
        public final PBStringField f5112msg = PBField.initString("");
    }

    /* compiled from: P */
    /* loaded from: classes.dex */
    public static final class StCommonExt extends MessageMicro<StCommonExt> {
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18}, new String[]{"mapInfo", "attachInfo"}, new Object[]{null, ""}, StCommonExt.class);
    ...
    public static final class User extends MessageMicro<User> {
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26}, new String[]{"uin", "appid", "openid"}, new Object[]{0, "", ""}, User.class);
